...
class Booking_Boat_Rental_Woocommerce {
	...
	private function define_admin_hooks() {
		...
		$this->loader->add_action( 'services_add_form_fields', $plugin_admin, 'boat_add_services_icon' );
		$this->loader->add_action( 'services_edit_form_fields', $plugin_admin, 'boat_edit_services_icon' );
		$this->loader->add_action( 'edited_services', $plugin_admin, 'boat_save_services_icon' );
		$this->loader->add_action( 'create_services', $plugin_admin, 'boat_save_services_icon' );
		$this->loader->add_filter( 'manage_edit-services_columns', $plugin_admin, 'boat_add_services_columns' );
		$this->loader->add_filter('manage_services_custom_column', $plugin_admin, 'boat_add_services_column_content',10,3);

		// features taxonomy
		$this->loader->add_action( 'features_add_form_fields', $plugin_admin, 'boat_add_features_icon' );
		$this->loader->add_action( 'features_edit_form_fields', $plugin_admin, 'boat_edit_features_icon' );
		$this->loader->add_action( 'edited_features', $plugin_admin, 'boat_save_features_icon' );
		$this->loader->add_action( 'create_features', $plugin_admin, 'boat_save_features_icon' );
		$this->loader->add_filter( 'manage_edit-features_columns', $plugin_admin, 'boat_add_features_columns' );
		$this->loader->add_filter('manage_features_custom_column', $plugin_admin, 'boat_add_features_column_content',10,3);
	...
	private function define_public_hooks() {
		...
		$this->loader->add_filter( 'woocommerce_order_button_text', $plugin_public, 'custom_button_text_place_order' );
		$this->loader->add_filter( 'woocommerce_endpoint_order-received_title', $plugin_public, 'misha_thank_you_title' );
		$this->loader->add_action( 'woocommerce_review_order_before_payment', $plugin_public, 'woocommerce_checkout_coupon_form_custom' );
	}
