...
<div class="container">
	...
	<div class="row">
		...
		<div class="col-md-9 product" id="products">
				<?php
							...
							<div class="item col-xs-4 col-lg-4">
								<div class="thumbnail">
									<div class="img-inner">
										...
										<div class="group list-group-image" style="background-image: url(<?php echo $image[0]; ?>); background-position: center; background-size: cover;">
									...
									<div class="caption">
										...
										<div class="action-right pull-right">
											<a class="btn" href="<?php the_permalink(); ?>"><i class="bi bi-eye"></i> View Detail</a>
											<a class="btn" href="<?php echo site_url(); ?>/shop-reserve/?vat=<?php echo get_the_ID(); ?>"><i class="bi bi-calendar-plus"></i> Reserve Now</a>
										</div>
									</div>
								</div>
							</div>
