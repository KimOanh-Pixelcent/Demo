<?php 
	...
	$srcImage = get_the_post_thumbnail_url( $post_id, 'full' );
?>
        ...
        <div class="row">
					...
					<?php	$dem++;
						...
						<div class="form-group">
							...
							<div class="input-group people-number">
								...
								<input type="text" name="quant[1]" class="form-control input-number" value="1" min="1" max="<?= !empty($bbrw_capacity)? $bbrw_capacity : 10; ?>">
								<span class="input-group-btn">
            ...
            <div class="col-lg-6">
				...
				<div class="item active">
                  	<img src="<?php echo $srcImage;; ?>" alt="" width="1100" height="500">
                </div>
				<p class="line-bt"></p>
